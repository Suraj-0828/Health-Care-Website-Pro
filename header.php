                     ...
                     <div class="row">
                         <div class="col-xl-6 col-lg-7">
                             <div class="tp-header-top-content">
                                 <span><i class="fa-solid fa-phone-volume"></i> Talk with us: <a href="tel:0208755584">0208755584</a></span>
                                 <span><i class="fa-sharp fa-solid fa-envelope text-black"></i> <a href="mailto:info@democareservices.co.uk">
                         ...
                         <div class="col-xl-6 col-lg-5">
                             <div class="tp-header-top-social text-md-end">
                                 ...
                                 <a href="javascript:void(0)"><img src="assets/img/about/twitter.png" style="width: 12px;"/></a>
                                 <a href="javascript:void(0)"><i class="fa-brands fa-instagram text-black"></i></a>
                             </div>
                         </div>
                     </div>
                 </div>

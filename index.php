...
<body>
   ...
   <main>
      ...
      <div class="slider desktop-slider">
         <ul>
            <li><img src="assets/img/about/hello/dcs-banner-4.jpg" alt="Desktop Image 1"></li>
            <li><img src="assets/img/about/hello/dcs-banner-5.jpg" alt="Desktop Image 2"></li>
            <li><img src="assets/img/about/hello/dcs-banner-6.jpg" alt="Desktop Image 3"></li>
         </ul>
      ...
      <div class="slider mobile-slider">
         <ul>
            <li><img src="assets/img/about/hello/dcs-mobile-banner-4.jpg" alt="Mobile Image 1"></li>
            <li><img src="assets/img/about/hello/dcs-mobile-banner-5.jpg" alt="Mobile Image 2"></li>
            <li><img src="assets/img/about/hello/dcs-mobile-banner-6.jpg" alt="Mobile Image 3"></li>
         </ul>
                     ...
                     <div class="tp-services-3-thumb p-relative">
                        <div class="fix p-relative">
                           ...
                           <div class="tp-services-3-content">
                              ...
                              <h4 class="tp-services-3-title"><a class="text-white-1" href="children-care.php">Children Care</a></h4>
                              <p class="text-white-1">Nurturing young lives with attentive, compassionate care for a brighter future.</p>
                              <a class="tp-services-btn" href="children-care.php">Explore More <i class="fa-regular fa-arrow-right-long"></i></a>
                           </div>
                        </div>
                     ...
                     <div class="tp-services-3-thumb p-relative">
                        <div class="fix p-relative">
                           ...
                           <div class="tp-services-3-content">
                              ...
                              <h4 class="tp-services-3-title"><a class="text-white-1" href="elder-care.php">Adult care</a></h4>
                              <p class="text-white-1">Providing respectful and supportive care to enhance the golden years.</p>
                              <a class="tp-services-btn" href="elder-care.php">Explore More <i class="fa-regular fa-arrow-right-long"></i></a>
                           </div>
                        </div>
                        <div class="tp-services-3-info">
                           <div class="tp-services-3-info-icon">
                           ...
                           <h4 class="tp-services-3-info-title">Adult care</h4>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 mb-6000">
                  <div class="tp-services-3-item">
                     <div class="tp-services-3-thumb p-relative">
                        <div class="fix p-relative">
                           ...
                           <div class="tp-services-3-content">
                              ...
                              <h4 class="tp-services-3-title"><a class="text-white-1" href="disable-care.php">Disabled Care</a></h4>
                              <p class="text-white-1">Empowering individuals with disabilities through personalized and dignified support.</p>
                              <a class="tp-services-btn" href="disable-care.php">Explore More <i class="fa-regular fa-arrow-right-long"></i></a>
                           </div>
                        </div>
                        <div class="tp-services-3-info">
                           <div class="tp-services-3-info-icon">
                     ...
                     <div class="tp-services-3-thumb p-relative">
                        <div class="fix p-relative">
                           ...
                           <div class="tp-services-3-content">
                              ...
                              <h4 class="tp-services-3-title"><a class="text-white-1" href="disable-care.php#fourpage">Supported Living Accommodation</a></h4>
                              <p class="text-white-1">True power lies in the ability to care and uplift others understanding.</p>
                              <a class="tp-services-btn" href="disable-care.php#fourpage">Explore More <i class="fa-regular fa-arrow-right-long"></i></a>
                           </div>
                        </div>
                        <div class="tp-services-3-info">
                           <div class="tp-services-3-info-icon">
                           ...
                           <h4 class="tp-services-3-info-title">Supported Living Accommodation</h4>
                        </div>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row">
                           <div class="col-xl-6 col-lg-6 col-md-6">
                              <div class="tp-contact-item">
                                 <span>Contact</span>
                                 <a href="tel:0208755584">0208755584</a><br>
                                 <a href="tel:07450268531">07450268531</a><br>
                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6">
                              <div class="tp-contact-item ml-15">
                                 <span>Email</span>
                                 <a href="mailto:democare@icloud.com">
                                    democare@icloud.com</a><br>
